...
## Sources
- [[2026-09-16-判断分层-弱相关-否决]] — 判断分层: 弱相关 != 否决。规则表只能否决【逻辑上不成立/答非所问】的(如'去查百科'答不了'苹果好吃吗')…
- [[2026-09-16-l2-的职能是划定问题边界-不是复述问题]] — L2 的职能是划定问题边界, 不是复述问题。复述不产生信息, 划边界产生信息。三条轴: 主观/客观 · 当下/长期 · 判断/操作。每条轴必须落到一端…
## Syntheses
- [[abs-think-tree]] — 三层思考骨架 (L1动机/L2边界/L3产出)：下坠+兄弟竞争，裁判是父节点而非答案；一次 forward pass，非 n 次调用
